...
{
	$sqlstr = "select * from wn_latestinfo where id=".$_REQUEST["uid"];
	//echo $sqlstr;
	...
	if($rs = mysql_fetch_array($myResult))
	{
		...
		$rec_news  =stripslashes($rs["rec_news"]);
		$image   =stripslashes($rs["image"]);
		$headline  =stripslashes($rs["headline"]);
		$rec_discription  =stripslashes($rs["rec_discription"]);
...
function fnValidate(id)
{
		...
		var iid=document.frmFinal.rec_news.value;
		if(iid==''){
			alert('Please Fill Recent News');
			return false;
		}
		...
		var iid=document.frmFinal.rec_discription.value;
		if(iid==''){
			alert('aPlease Fill tyhe Rercent discription');
			return false;
		}
	...
	if(id==1)
	{
		document.frmFinal.action="submitproduct1.php?app="+id;
	}
	else
	{
		document.frmFinal.action="submitproduct1.php?app="+id;
 ...
 <tr>
  ...
  <tr>
    <td width="51%" height="40" align="left" valign="bottom"><table border="0" cellspacing="0" cellpadding="0" style="margin-left:30px;">
      <tr>
        <td class="innerpageheading" height="40">Content Management : Latest News</td>
        </tr>
    </table></td>
        ...
        <td height="100%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
			...
			<table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#E2E2E2" style="border-bottom:1px solid #D2001E;">
              <tr>
                <td width="100%" height="25" align="left" valign="middle" background="images/tab_img_bg.gif" class="tableheading" style="padding-left:25px;"><?=$_REQUEST["tType"]?> Latest News updates  </td>
                </tr>
              ...
              <tr>
                <td width="100%" height="250" align="center" valign="top" bgcolor="#fbfbfb"><table width="60%" border="0" align="left" cellpadding="1" cellspacing="1">
				  ...
				  <tr>
                    <td width="12%" height="25" align="left" valign="middle" style="padding-left:15px;">News Healine: </td>
                    <td height="25" colspan="2" align="left">
                      <textarea name="rec_news" class="form"  rows="5" cols="57" /><?=$rec_news ?></textarea></td>
                  </tr>
				  <tr>
         
               <tr>
				<td width="12%" height="25" align="left" valign="middle" style="padding-left:15px;">  Latest Image : </td>
                ...
                <input name="previmg" type="hidden" value="<?=$image?>" >
				  ...
				  <tr>
                    <td width="12%" height="25" align="left" valign="middle" style="padding-left:15px;">News Description  : </td>
                    <td height="25" colspan="2" align="left">
                      <textarea name="rec_discription" type="text" class="form" rows="5" cols="57" /><?=$rec_discription ?></textarea></td>
                  </tr>
