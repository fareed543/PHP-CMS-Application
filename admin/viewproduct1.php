...
$count_que="select count(*) from wn_latestinfo ";
...
if(isset($_GET["va"])){
	switch($_GET["va"]){
		case '1':
			$message="Latest News Added";
			break;
		case '2':
			$message="Selected News Modified";
			break;
		case '3':
			$message="Selected News Deleted";
			break;
		case '4':
...
$strSql="select * from wn_latestinfo order by $sortby $disType limit $limit1,$pagelimit";
...
function fnAdd()
{
	window.location.href="editproduct1.php?tType=Add";
}
function fnDetails()
{
	...
	{
		window.location.href="editproduct1.php?tType=Edit&pg=<?=$pg?>&uid="+arrval[0];
	}
	}
...
{	
	...
	}else if(flag==1)
	{
			var i,len,chkdelids,sep;
			  ...
			  sep="";
				...
				ConfirmStatus = confirm("Do you want to DELETE selected News?")

                if (ConfirmStatus == true) {

				document.frmMain.chkdelids.value=chkdelids
				document.frmMain.tType.value="Del"
				document.frmMain.action="submitproduct1.php";
  ...
  <tr>
    <td width="25%" height="40" align="left" valign="middle"><table border="0" cellspacing="0" cellpadding="0" style="margin-left:30px;">
	  <tr>
        <td height="40" ><span class="innerpageheading">Content Management : </span><span class="innerpageheading1">Latest News</span></td>
      </tr>
    </table></td>
    ...
    <td height="100%" colspan="3" align="center" valign="top"><table width="96%" height="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="25" bgcolor="F5F5F5"><table width="100%" height="25" border="0" cellpadding="1" cellspacing="1">
              <tr>
                <td width="25%" align="left" bgcolor="#F5F5F5" style="padding-left:25px;"><strong>:Latest News Updates( <?=$total_count?> )</strong> </td>
		...
		<td width="5%" height="20" align="center" valign="middle" background="images/tab_img_bg.gif" class="tableheading"><input type="checkbox" name="checkall" onClick="Checkall()"/></td>
				...
				<!-- <td height="45%" width="200" align="center" valign="middle" background="images/tab_img_bg.gif" class="tableheading"><a href="<?=$myurl."&sortby=name"?>" class="link3">Recent Numbers</a></td>
				
		
		<td height="45%" width="200" align="center" valign="middle" background="images/tab_img_bg.gif" class="tableheading"><a href="<?=$myurl."&sortby=name"?>" class="link3">Recent Emails</a></td>
 -->
				<td height="45%" width="200" align="center" valign="middle" background="images/tab_img_bg.gif" class="tableheading"><a href="<?=$myurl."&sortby=name"?>" class="link3">Latest News Headline</a></td>
				
	            <td height="45%" align="center" valign="middle" background="images/tab_img_bg.gif" class="tableheading">News Discription</td>
              ...
              <tr>
                ...
                <td height="20" width="23%" bgcolor="<?=$color?>" style="padding-left:10px;" align="left"><a href="editproduct1.php?tType=Edit&uid=<?php echo $rs["id"];?>" style="color:black;cursor:pointer;text-decoration:underline;" class="tt"><?echo $rs["rec_news"]; ?><span class="tooltip"><img src="../products/<?php echo $rs["image"]?>" border="1" width="300" height="200"   ></span></a></td>
              
				<!-- <td height="20" align="center" bgcolor="<?=$color?>"><?php echo $rs["rec_emails"]; ?></td>
				
				<td height="20" align="center" bgcolor="<?=$color?>"><?php echo $rs["rec_news"]; ?></td>
				 -->
				<td height="20" align="center" bgcolor="<?=$color?>">
					<?php echo substr($rs["rec_discription"],0,60) ?></td>
                </tr>
