...
$count_que="select count(*) from wn_contacts";
...
$strSql="select * from wn_contacts ";
...
function fnAdd()
{
	window.location.href="editcontact.php?tType=Add";
}
function fnDetails()
{
	...
	{
		window.location.href="editcontact.php?tType=Edit&pg=<?=$pg?>&uid="+arrval[0];
	}
	}
...
{	
	...
	}else if(flag==1)
	{
			var i,len,chkdelids,sep;
			  ...
			  sep="";
				...
				document.frmMain.action="submitcontact.php";
  ...
  <tr>
    <td width="25%" height="40" align="left" valign="middle"><table border="0" cellspacing="0" cellpadding="0" style="margin-left:30px;">
	  <tr>
        <td height="40" ><span class="innerpageheading">Content Management : </span><span class="innerpageheading1">Contact Details</span></td>
      </tr>
    </table></td>
    ...
    <td height="100%" colspan="3" align="center" valign="top"><table width="96%" height="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="25" bgcolor="F5F5F5"><table width="100%" height="25" border="0" cellpadding="1" cellspacing="1">
              <tr>
                <td width="25%" align="left" bgcolor="#F5F5F5" style="padding-left:25px;"><strong>Contact Information( <?=$total_count?> )</strong> </td>
		...
		<td width="5%" height="20" align="center" valign="middle" background="images/tab_img_bg.gif" class="tableheading"><input type="checkbox" name="checkall" onClick="Checkall()"/></td>
				...
				<td height="45%" width="200" align="center" valign="middle" background="images/tab_img_bg.gif" class="tableheading"><a href="<?=$myurl."&sortby=name"?>" class="link3">Contact Numbers</a></td>
		...
		<td height="45%" width="200" align="center" valign="middle" background="images/tab_img_bg.gif" class="tableheading"><a href="<?=$myurl."&sortby=name"?>" class="link3">Recent Emails</a></td>
				...
				<td height="45%" width="200" align="center" valign="middle" background="images/tab_img_bg.gif" class="tableheading"><a href="<?=$myurl."&sortby=name"?>" class="link3">Current Address</a></td>
              ...
              <tr>
                ...
                <td height="20" bgcolor="<?=$color?>" style="padding-left:10px;" align="left"><a href="editcontact.php?tType=Edit&uid=<?php echo $rs["id"];?>" style="color:black;cursor:pointer;text-decoration:underline;" class="tt"><?echo $rs["rec_numbers"]; ?></a></td>
              
				<td height="20" align="center" bgcolor="<?=$color?>"><?php echo $rs["rec_emails"]; ?></td>
				
				<td height="20" align="center" bgcolor="<?=$color?>"><?php echo $rs["address"]; ?></td>
