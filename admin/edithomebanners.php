...
{
	$sqlstr = "select * from wn_index_gallery where in_id=".$_REQUEST["uid"];
...
function fnValidate(id)
{
	...
	if(id==1)
	{
		document.frmFinal.action="submithomebanners.php?app="+id;
	}
	else
	{
		document.frmFinal.action="submithomebanners.php?app="+id;
 ...
 <tr>
  ...
  <tr>
    <td width="51%" height="40" align="left" valign="bottom"><table border="0" cellspacing="0" cellpadding="0" style="margin-left:30px;">
      <tr>
        <td class="innerpageheading" height="40">Content Management : Photo Gallery</td>
        </tr>
    </table></td>
        ...
        <td height="100%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
			...
			<table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#E2E2E2" style="border-bottom:1px solid #D2001E;">
              <tr>
                <td width="100%" height="25" align="left" valign="middle" background="images/tab_img_bg.gif" class="tableheading" style="padding-left:25px;"><?=$_REQUEST["tType"]?> Gallery Details </td>
                </tr>
              ...
              <tr>
                ...
                <tr>
                 ...
                 <tr>
				   ...
				   <input name="in_image" type="file" >&nbsp;<a href="#" style="color:black;cursor:pointer;text-decoration:underline;" class="tt"><?echo $in_image; ?><span class="tooltip"><img src="http://localhost/claps/uploads/<?=$rs["in_image"]?>" border="0" ></span></a>
