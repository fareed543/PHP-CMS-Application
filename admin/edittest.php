...
if (isset($_REQUEST["uid"]) && $_REQUEST["uid"]!=0)
{
	...
	{
		//$ename		= $rs["e_name"];
		$tst_name  =stripslashes($rs["tst_name"]);
...
function fnValidate(id)
{
	...
	if(id==1)
	{
		document.frmFinal.action="submittest.php?app="+id;
	}
	else
	{
		document.frmFinal.action="submittest.php?app="+id;
 ...
 <tr>
  ...
  <tr>
    <td width="51%" height="40" align="left" valign="bottom"><table border="0" cellspacing="0" cellpadding="0" style="margin-left:30px;">
      <tr>
        <td class="innerpageheading" height="40">Testimonials:</td>
        </tr>
    </table></td>
          ...
          <tr>
			...
			<table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#E2E2E2" style="border-bottom:1px solid #D2001E;">
              ...
              <tr>
                ...
                <tr>
                    <td width="17%" height="25" align="left" valign="middle" style="padding-left:15px;">Name : </td>
                    <td width="48%" height="25" align="left">
                      <input name="tst_name" type="text" readonly class="form" value="<?php echo $rs['tst_name']; ?>" size="30" onBlur="fnCheckSpaces(this)"/>      </td>
                    </tr>
                <tr>
                    <td width="17%" height="25" align="left" valign="middle" style="padding-left:15px;">Title : </td>
                    <td width="48%" height="25" align="left">
                      <input name="tst_title" type="text"  class="form" value="<?php echo $rs['tst_title']; ?>" size="30" onBlur="fnCheckSpaces(this)"/>      </td>
                    </tr>

					<tr>
                    <td width="17%" height="25" align="left" valign="middle" style="padding-left:15px;">Description : </td>
                    <td width="48%" height="25" align="left">
					<textarea name="tst_desc"  rows="5" cols="80" class="form"  onBlur="fnCheckSpaces(this)" ><?php echo $rs['tst_desc']; ?></textarea>
                            </td>
                    </tr>
                    
                             <tr>
                    <td width="17%" height="25" align="left" valign="middle" style="padding-left:15px;">Date : </td>
					<td width="48%" height="25" align="left">
					<input name="date" type="text"  class="form" value="<?php echo $rs['date']; ?>" size="30" onBlur="fnCheckSpaces(this)"/>
