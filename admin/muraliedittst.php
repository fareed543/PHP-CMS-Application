...
if(isset($_REQUEST["uid"]) && $_REQUEST["uid"]!=0){
	$sql = "select * from murali_tst where tst_id=".$_GET["uid"];
...
function fnValidate(id)
{
	...
	if(id==1)
	{
		document.frmFinal.action="muralisubmittst.php?app="+id;
	}
	else
	{
		document.frmFinal.action="muralisubmittst.php?app="+id+"&"+"tType=Edit";
	}
              ...
              <tr>
                ...
                <tr>
                    ...
                    <td height="25" colspan="2" align="left">
                      <input name="tst_name" type="text" class="form" value="<?PHP ECHO $tst_name?>" size="60" /></td>
                  </tr>
				    <tr>
                    ...
                    <td height="25" colspan="2" align="left">
                      <textarea name="tst_desc" type="text" class="form" value="<?PHP ECHO $tst_desc; ?>" rows="5" cols="57" /></textarea></td>
                  </tr>
				    <tr>
