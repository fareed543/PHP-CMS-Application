...
{
	$sqlstr = "select * from wn_expert where photo_id=".$_REQUEST["uid"];
	//echo $sqlstr;
...
function fnValidate(id)
{
	var iid=document.frmFinal.title.value;
		...
		if(iid==''&& iiid==''){
			alert('Please Upload the Expert image');
			return false;
		}
	if(id==1)
	{
		document.frmFinal.action="submitexpert.php?app="+id;
	}
	else
	{
		document.frmFinal.action="submitexpert.php?app="+id;
 ...
 <tr>
  ...
  <tr>
    <td width="51%" height="40" align="left" valign="bottom"><table border="0" cellspacing="0" cellpadding="0" style="margin-left:30px;">
      <tr>
        <td class="innerpageheading" height="40">Content Management : Our Experts</td>
        </tr>
    </table></td>
        ...
        <td height="100%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
			...
			<table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#E2E2E2" style="border-bottom:1px solid #D2001E;">
              <tr>
                <td width="100%" height="25" align="left" valign="middle" background="images/tab_img_bg.gif" class="tableheading" style="padding-left:25px;"><?=$_REQUEST["tType"]?> Our Experts </td>
                </tr>
              ...
              <tr>
                ...
                <tr>
                    ...
                    <td height="25" colspan="2" align="left">
                      <input name="title" type="text" class="form" value="<?=$title?>" size="60" /></td>
                  </tr>  
				  <tr>
                    <td width="12%" height="25" align="left" valign="middle" style="padding-left:15px;">link  : </td>
                    <td height="25" colspan="2" align="left">
                      <input name="link" type="text" class="form" value="<?=$link?>" size="60" /></td>
                  </tr>
				                   <tr>
				   ...
				   <input name="image" type="file" >&nbsp;<a href="#" style="color:black;cursor:pointer;text-decoration:underline;" class="tt"><?echo $image; ?><span class="tooltip"><img src="../uploads/<?php echo $rs['image']?>" border="0" ></span></a>
