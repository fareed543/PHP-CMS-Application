...
$count_que="select count(*) from wn_tst";
...
if(isset($_GET["va"])){
	switch($_GET["va"]){
		case '1':
			...
			break;
		case '2':
			$message="Selected Content Modified";
			break;
		case '3':
			$message="Selected Content Deleted";
			break;
		case '4':
...
$strSql="select * from wn_tst order by $sortby $disType limit $limit1,$pagelimit";
//echo $strSql;
...
function fnAdd()
{
	window.location.href="edittest.php?tType=Add";
}
function fnDetails()
{
	...
	{
		window.location.href="edittest.php?tType=Edit&pg=<?=$pg?>&uid="+arrval[0];
	}
	}
...
{	
	...
	}else if(flag==1)
	{
			var i,len,chkdelids,sep;
			  ...
			  sep="";
				...
				ConfirmStatus = confirm("Do you want to DELETE selected Content?")

                if (ConfirmStatus == true) {

				document.frmMain.chkdelids.value=chkdelids
				document.frmMain.tType.value="Del"
				document.frmMain.action="submitadvs1.php";
  ...
  <tr>
    <td width="25%" height="40" align="left" valign="middle"><table border="0" cellspacing="0" cellpadding="0" style="margin-left:30px;">
	  <tr>
        <td height="40" ><span class="innerpageheading">Content Management : </span><span class="innerpageheading1">Pages</span></td>
      </tr>
    </table></td>
		  ...
		  <tr>
            <td valign="top"><table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#E2E2E2" style="border-bottom:1px solid #D2001E;">
              <tr>
                ...
                <td height="45%" align="center" valign="middle" background="images/tab_img_bg.gif" class="tableheading"><a href="<?=$myurl."&sortby=tst_name"?>" class="link3">Name</a> </td>
				 <td height="45%" align="center" valign="middle" background="images/tab_img_bg.gif" class="tableheading"><a href="<?=$myurl."&sortby=tst_title"?>" class="link3">Title</a> </td>
				  <td height="45%" align="center" valign="middle" background="images/tab_img_bg.gif" class="tableheading"><a href="<?=$myurl."&sortby=tst_desc"?>" class="link3">Description</a> </td>
				   <td height="45%" align="center" valign="middle" background="images/tab_img_bg.gif" class="tableheading"><a href="<?=$myurl."&sortby=date"?>" class="link3">Date</a> </td>
				<!-- Center Inner Light <td height="45%" align="center" valign="middle" background="images/tab_img_bg.gif" class="tableheading">Sub Title </td> -->
              ...
              <tr>
                ...
                <td height="20" align="center" bgcolor="<?=$color?>">
				<input type="checkbox" name="selectcheck" value="<?=$rs["tst_id"]?>"/></td>
                <td height="20" bgcolor="<?=$color?>" style="padding-left:10px;" align="center"><a href="edittest.php?tType=Edit&uid=<?=$rs["tst_id"]?>" style="color:black"><?=$rs["tst_name"]?></a></td>
 ...
 <!-- <td height="20" bgcolor="<?=$color?>" style="padding-left:10px;" align="center"><a href="editadvs1.php?tType=Edit&uid=<?=$rs["cms_id"]?>" style="color:black"><?=$rs["sub_title"]?></a></td> -->
		  ...
		  <tr>
            <td valign="top"><table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#E2E2E2" style="border-bottom:1px solid #D2001E;">
              ...
              <tr>
                <td height="100" align="center" bgcolor="#FFFFFF" colspan="9" class="pagingbold">Currently No Contents To Display</td>
              </tr>
            </table></td>
          </tr>
		  <?}?>
		...
		<input type="hidden" name="chkdelids">
          ...
          <tr>
            <td height="25" align="center" bgcolor="#F5F5F5"><?if($pg>1){?><a href="viewcms.php?pg=1&disType=<?=$disType1?>&sortby=<?=$sortby?>" class="link3">&lt;&lt; Start</a><?}else{?><span class="link3">&lt;&lt; Start</span><?}?>&nbsp;&nbsp;<?if($pg>1){?><a href="viewcms.php?pg=<?=$pg-1?>&disType=<?=$disType1?>&sortby=<?=$sortby?>" class="link3">&lt; Previous&nbsp;</a><?}else{?><span class="link3">&lt; Previous&nbsp;</span><?}?> | <?if($intpagecount>$pg){?>&nbsp;<a href="viewcms.php?pg=<?=$pg+1?>&disType=<?=$disType1?>&sortby=<?=$sortby?>" class="link3">Next &gt;</a><?}else{?>&nbsp;<span class="link3">Next &gt;</span><?}?> <?if($intpagecount>$pg){?>&nbsp;<a href="viewcms.php?pg=<?=$intpagecount?>&disType=<?=$disType1?>&sortby=<?=$sortby?>" class="link3">End &gt;&gt;</a><?}else{?>&nbsp;<span class="link3">End &gt;&gt;</span><?}?></td>
          </tr>
		  <?}else{?>
		  <tr>
