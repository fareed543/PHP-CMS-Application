...
function fnValidate(id)
{
	...
	if(id==1)
	{
		document.frmFinal.action="submitevent.php?app="+id;
	}
	else
	{
		document.frmFinal.action="submitevent.php?app="+id;
 ...
 <tr>
  ...
  <tr>
    <td width="51%" height="40" align="left" valign="bottom"><table border="0" cellspacing="0" cellpadding="0" style="margin-left:30px;">
      <tr>
        <td class="innerpageheading" height="40">Event Manager :</td>
        </tr>
    </table></td>
        ...
        <td height="100%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
			...
			<table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#E2E2E2" style="border-bottom:1px solid #D2001E;">
              <tr>
                <td width="100%" height="25" align="left" valign="middle" background="images/tab_img_bg.gif" class="tableheading" style="padding-left:25px;"><?=$_REQUEST["tType"]?> Event Details </td>
                </tr>
              ...
              <tr>
               ...
               <tr>
                    <td width="12%" height="25" align="left" valign="middle" style="padding-left:15px;">Event name  : </td>
                    <td height="25" colspan="2" align="left">
                      <input name="e_name" type="text" class="form" value="<?=$e_name?>" size="60" /></td>
                  </tr>
                 <tr>
