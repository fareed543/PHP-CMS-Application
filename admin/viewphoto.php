...
$count_que="select count(*) from wn_photo";
...
if(isset($_GET["va"])){
	switch($_GET["va"]){
		case '1':
			...
			break;
		case '2':
			$message="Selected Gallery Modified";
			break;
		case '3':
			$message="Selected Gallery Deleted";
			break;
		case '4':
...
$strSql="select * from wn_photo order by $sortby $disType limit $limit1,$pagelimit";
...
function fnAdd()
{
	window.location.href="editphoto.php?tType=Add";
}
function fnDetails()
{
	...
	{
		window.location.href="editphoto.php?tType=Edit&pg=<?=$pg?>&uid="+arrval[0];
	}
	}
...
{	
	...
	}else if(flag==1)
	{
			var i,len,chkdelids,sep;
			  ...
			  sep="";
				...
				document.frmMain.action="submitphoto.php";
  ...
  <tr>
    <td width="25%" height="40" align="left" valign="middle"><table border="0" cellspacing="0" cellpadding="0" style="margin-left:30px;">
	  <tr>
        <td height="40" ><span class="innerpageheading">Content Management : </span><span class="innerpageheading1">Photo Gallery</span></td>
      </tr>
    </table></td>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="25" bgcolor="F5F5F5"><table width="100%" height="25" border="0" cellpadding="1" cellspacing="1">
              <tr>
                <td width="25%" align="left" bgcolor="#F5F5F5" style="padding-left:25px;"><strong>Gallery ( <?=$total_count?> )</strong> </td>
		  ...
		  <tr>
            <td valign="top"><table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#E2E2E2" style="border-bottom:1px solid #D2001E;">
              ...
              <tr>
                ...
                <td height="20" bgcolor="<?=$color?>" style="padding-left:10px;" align="left"><a href="editphoto.php?tType=Edit&uid=<?php echo $rs["photo_id"];?>" style="color:black;cursor:pointer;text-decoration:underline;" class="tt"><?echo $rs["title"]; ?><span class="tooltip"><img src="../uploads/<?php echo $rs["image"]?>" border="0" ></span></a></td>
