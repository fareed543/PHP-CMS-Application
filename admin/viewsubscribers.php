...
$count_que="select count(*) from wn_subscribers";
...
$strSql="select * from wn_subscribers order by id DESC";
...
function fnAdd()
{
	window.location.href="composemail.php?tType=Add";
}
function fnDetails()
{
	...
	{
		window.location.href="composemail.php?tType=Edit&pg=<?=$pg?>&uid="+arrval[0];
	}
	}
...
{	
	...
	}else if(flag==1)
	{
			var i,len,chkdelids,sep;
			  ...
			  sep="";
				...
				ConfirmStatus = confirm("Do you want to DELETE selected Email?")

                if (ConfirmStatus == true) {

				document.frmMain.chkdelids.value=chkdelids
				document.frmMain.tType.value="Del"
				document.frmMain.action="submitsubscribers.php";
			  ...
			  <TABLE id=toolbar cellSpacing=0 cellPadding=0 border=0>
				<TBODY>
				  <TR vAlign=center align=middle>
					  <TD align="center"><A class=toolbar href="javascript: fnAdd();"><IMG src="images/new_ico.png" alt=mail width="32" height="32" border=0 align=middle id="Add"><BR>Mail</A></TD>
					  <TD align="center">&nbsp;</TD>
  ...
  <tr>
    <td width="25%" height="40" align="left" valign="middle"><table border="0" cellspacing="0" cellpadding="0" style="margin-left:30px;">
	  <tr>
        <td height="40" ><span class="innerpageheading">Content Management : </span><span class="innerpageheading1">Email Subscribers</span></td>
      </tr>
    </table></td>
  ...
  <tr>
    <td height="100%" colspan="3" align="center" valign="top"><table width="96%" height="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="25" bgcolor="F5F5F5"><table width="100%" height="25" border="0" cellpadding="1" cellspacing="1">
              <tr>
                <td width="25%" align="left" bgcolor="#F5F5F5" style="padding-left:25px;"><strong>Subscribers ( <?=$total_count?> )</strong> </td>
		...
		<td height="45%" width="200" align="center" valign="middle" background="images/tab_img_bg.gif" class="tableheading"><a href="<?=$myurl."&sortby=name"?>" class="link3">Email Address</a></td>
              ...
              <tr>
				...
				<td height="20" align="center" bgcolor="<?=$color?>"><?php echo $rs["email"]; ?></td>
                </tr>
			  <?$i=$i+1;$c++;}?>
            </table></td>
          </tr>
		  ...
		  <tr>
            <td valign="top"><table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#E2E2E2" style="border-bottom:1px solid #D2001E;">
              ...
              <tr>
                <td height="100" align="center" bgcolor="#FFFFFF" colspan="9" class="pagingbold">Currently No Emails are Subscribed </td>
              </tr>
            </table></td>
          </tr>
		  <?}?>
