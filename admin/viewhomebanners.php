...
$count_que="select count(*) from wn_index";
...
if(isset($_GET["va"])){
	switch($_GET["va"]){
		case '1':
			...
			break;
		case '2':
			$message="Selected Banner Modified";
			break;
		case '3':
			$message="Selected Banner Deleted";
			break;
		case '4':
...
if(!isset($sortby)) { $sortby="in_image";}
...
$strSql="select * from wn_index order by $sortby $disType limit $limit1,$pagelimit";
...
function fnAdd()
{
	window.location.href="edithomebanners.php?tType=Add";
}
function fnDetails()
{
	...
	{
		window.location.href="edithomebanners.php?tType=Edit&pg=<?=$pg?>&uid="+arrval[0];
	}
	}
...
{	
	...
	}else if(flag==1)
	{
			var i,len,chkdelids,sep;
			  ...
			  sep="";
				...
				document.frmMain.action="submithomebanners.php";
  ...
  <tr>
    <td width="25%" height="40" align="left" valign="middle"><table border="0" cellspacing="0" cellpadding="0" style="margin-left:30px;">
	  <tr>
        <td height="40" ><span class="innerpageheading">Content Management : </span><span class="innerpageheading1">Home Banners</span></td>
      </tr>
    </table></td>
    ...
    <td height="100%" colspan="3" align="center" valign="top"><table width="96%" height="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="25" bgcolor="F5F5F5"><table width="100%" height="25" border="0" cellpadding="1" cellspacing="1">
              <tr>
                <td width="25%" align="left" bgcolor="#F5F5F5" style="padding-left:25px;"><strong>Banners ( <?=$total_count?> )</strong> </td>
		  ...
		  <tr>
            <td valign="top"><table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#E2E2E2" style="border-bottom:1px solid #D2001E;">
              <tr>
                ...
                <td height="45%" align="center" valign="middle" background="images/tab_img_bg.gif" class="tableheading"><a href="<?=$myurl."&sortby=adv_image1"?>" class="link3">Name</a> </td>
              ...
              <tr>
				...
				<input type="checkbox" name="selectcheck" value="<?=$rs["in_id"]?>"/></td>
                <td height="20" bgcolor="<?=$color?>" style="padding-left:10px;" align="left"><a href="editadvs.php?tType=Edit&uid=<?php echo $rs["in_id"];?>" style="color:black;cursor:pointer;text-decoration:underline;" class="tt"><?echo $rs["in_image"]; ?><span class="tooltip"><img src="http://localhost/nav/uploads/<?=$rs["in_image"]?>" border="0" ></span></a></td>
		...
		<input type="hidden" name="chkdelids">
          ...
          <tr>
            <td height="25" align="center" bgcolor="#F5F5F5"><?if($pg>1){?><a href="viewhomebanners.php?pg=1&disType=<?=$disType1?>&sortby=<?=$sortby?>" class="link3">&lt;&lt; Start</a><?}else{?><span class="link3">&lt;&lt; Start</span><?}?>&nbsp;&nbsp;<?if($pg>1){?><a href="viewhomebanners.php?pg=<?=$pg-1?>&disType=<?=$disType1?>&sortby=<?=$sortby?>" class="link3">&lt; Previous&nbsp;</a><?}else{?><span class="link3">&lt; Previous&nbsp;</span><?}?> | <?if($intpagecount>$pg){?>&nbsp;<a href="viewhomebanners.php?pg=<?=$pg+1?>&disType=<?=$disType1?>&sortby=<?=$sortby?>" class="link3">Next &gt;</a><?}else{?>&nbsp;<span class="link3">Next &gt;</span><?}?> <?if($intpagecount>$pg){?>&nbsp;<a href="viewhomebanners.php?pg=<?=$intpagecount?>&disType=<?=$disType1?>&sortby=<?=$sortby?>" class="link3">End &gt;&gt;</a><?}else{?>&nbsp;<span class="link3">End &gt;&gt;</span><?}?></td>
          </tr>
		  <?}else{?>
		  <tr>
