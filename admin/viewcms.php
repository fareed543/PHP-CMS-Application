...
$count_que="select count(*) from wn_cms";
...
if(!isset($sortby)) { $sortby="cms_name";}
...
$strSql="select * from wn_cms order by $sortby $disType limit $limit1,$pagelimit";
...
function fnAdd()
{
	window.location.href="editcms.php?tType=Add";
}
function fnDetails()
{
	...
	{
		window.location.href="editcms.php?tType=Edit&pg=<?=$pg?>&uid="+arrval[0];
	}
	}
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="25" bgcolor="F5F5F5"><table width="100%" height="25" border="0" cellpadding="1" cellspacing="1">
              <tr>
                <td width="25%" align="left" bgcolor="#F5F5F5" style="padding-left:25px;"><strong>Pages ( <?=$total_count?> )</strong> </td>
		  ...
		  <tr>
            <td valign="top"><table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#E2E2E2" style="border-bottom:1px solid #D2001E;">
              <tr>
                ...
                <td height="45%" align="center" valign="middle" background="images/tab_img_bg.gif" class="tableheading"><a href="<?=$myurl."&sortby=cms_name"?>" class="link3">Page</a> </td>
			  ...
			  <?
				...
				?>
              <tr>
                <td height="50" align="center" bgcolor="<?=$color?>"><?=$i?></td>
                <td height="20" align="center" bgcolor="<?=$color?>">
				<input type="checkbox" name="selectcheck" value="<?=$rs["cms_id"]?>"/></td>
                <td height="20" bgcolor="<?=$color?>" style="padding-left:10px;" align="center"><a href="editcms.php?tType=Edit&uid=<?=$rs["cms_id"]?>" style="color:black"><?=$rs["cms_name"]?></a></td>
