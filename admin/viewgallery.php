...
$strSql="select * from wn_photogallery order by $sortby $disType limit $limit1,$pagelimit";
...
function fnAdd()
{
	window.location.href="editgallery.php?tType=Add";
}
function fnDetails()
{
	...
	{
		window.location.href="editgallery.php?tType=Edit&pg=<?=$pg?>&uid="+arrval[0];
	}
	}
	...
	}else if(flag==1)
	{
			var i,len,chkdelids,sep;
			  ...
			  sep="";
				...
				document.frmMain.action="submitgallery.php";
		  ...
		  <tr>
            <td valign="top"><table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#E2E2E2" style="border-bottom:1px solid #D2001E;">
              ...
              <tr>
                ...
                <td height="20" align="center" bgcolor="<?=$color?>"><input type="checkbox" name="selectcheck" value="<?=$rs["photogallery_id"]?>"/></td>
                <td height="20" bgcolor="<?=$color?>" style="padding-left:10px;" align="left"><a href="editgallery.php?tType=Edit&uid=<?php echo $rs["photogallery_id"];?>" style="color:black;cursor:pointer;text-decoration:underline;" class="tt"><?echo $rs["title"]; ?><span class="tooltip"><img src="http://localhost/claps/uploads/<?=$rs["image"]?>" border="0" ></span></a></td>
