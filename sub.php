...
$sql="INSERT INTO wn_subscribers (`email`) VALUES('$_POST[email]')";

			if(mysql_query($sql))
			{
			echo "<CENTER><H2>Your email is Successfully subscribed.</H2></CENTER>";
			}
			else{
			echo"<CENTER><H2>Your email is Exist in our records.</H2></CENTER>";
			}
?>
